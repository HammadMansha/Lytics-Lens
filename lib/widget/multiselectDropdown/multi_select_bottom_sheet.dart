...
import 'package:lytics_lens/widget/multiselectDropdown/utils/multi_select_actions.dart';
import 'package:lytics_lens/widget/multiselectDropdown/utils/multi_select_item.dart';
import 'package:lytics_lens/widget/multiselectDropdown/utils/multi_select_list_type.dart';
  ...
  Widget _buildListItem(MultiSelectItem<T> item) {
    return Theme(
      ...
      child: CheckboxListTile(
        visualDensity: const VisualDensity(horizontal: -3.5, vertical: -2.5),
